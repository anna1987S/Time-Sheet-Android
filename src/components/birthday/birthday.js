...
export default class Birthday extends Component {
    ...
    getTodayInfo = () => {
        ...
        console.log("request Birthday today",birthdayValues)
    ...
    getTomorrowInfo = () => {
        var {today,tomorrow,employeeRecordsFrom,employeeRecordsTo,next,previous,mobileSyncDate,
            profilePictureRequired,sessionData,calData} = this.state;
            console.log("tomorrow info",tomorrow)
        let items = [];
        var birthdayValues = {
    ...
    getPastInfo = () => {
        var {today,yesterday,pastDate,employeeRecordsFrom,employeeRecordsTo,next,previous,mobileSyncDate,
            profilePictureRequired,sessionData,calData} = this.state;
            console.log("yesterday",yesterday, "PastDate",pastDate)
        let items = [];
        var birthdayValues = {
    ...
    futureInfo = () => {
        var {today,tomorrow,futureDate,employeeRecordsFrom,employeeRecordsTo,next,previous,mobileSyncDate,
            profilePictureRequired,sessionData,calData} = this.state;
            console.log("futureDate",futureDate, "tomorrow",tomorrow)
        let items = [];
        var birthdayValues = {
            fromDate: this.ChangeDate(tomorrow),
        ...
        <View style={{width:SCREEN_WIDTH,flexDirection:'column',padding:10}}>
            <ScrollView>
            {
                ...
                <Card padder style={{width:'99%',borderRadius:10,padding:5}}>    
                    <CardItem cardBody>
                        <TouchableOpacity activeOpacity={0.8} onPress ={() => {propVal.navigation.navigate('EmpInfo',{ EmpDetail : value, navigateVal: "Birthday"})}}>
                            <View padder style={{flexDirection: 'row',width:'100%'}}>
                                ...
                                <Icon name="birthday-cake" type="FontAwesome" style={{ fontSize: 35, color: "#580073" }} />
                                </View>
                            </View>
                        </TouchableOpacity>
                    </CardItem>
